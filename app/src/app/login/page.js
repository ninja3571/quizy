          ...
          <Card className="bg-[rgba(102,102,153,0.2)] backdrop-blur-[2px] border-2 border-black">
            ...
            <CardContent className="space-y-2">
              <div className="space-y-1">
                ...
                <Input id="1username" placeholder="username" className="placeholder:text-fuchsia-600 border-black" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="1pass">Password</Label>
                <Input id="1pass" placeholder="password" className="placeholder:text-fuchsia-600 border-black" />
              </div>
            </CardContent>
          ...
          <Card className="bg-[rgba(102,102,153,0.2)] backdrop-blur-[2px] border-2 border-black">
            ...
            <CardContent className="space-y-2">
              <div className="space-y-1">
                ...
                <Input id="2username" placeholder="username" className="placeholder:text-fuchsia-600 border-black" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="2pass">Password</Label>
                <Input id="2pass" placeholder="password" className="placeholder:text-fuchsia-600 border-black" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="2pass2">Repeat Password</Label>
                <Input id="2pass2" placeholder="password" className="placeholder:text-fuchsia-600 border-black" />
              </div>
            </CardContent>
            <CardFooter className="flex justify-center">
